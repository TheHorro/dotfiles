...
-- State persistence
local state_file = vim.fn.stdpath('data') .. '/custom_debug_state.json'
...
function M.show_help()
  local help_lines = {
    ...
    "",
    "Available modules: lsp, editor, startup",
    "",
    "Profiles:",
    "  :lua require('custom.util.notifications').set_profile('minimal')",
    "  :lua require('custom.util.notifications').set_profile('verbose')",
    "  :lua require('custom.util.notifications').set_profile('debug')",
    "",
    "Categories:",
